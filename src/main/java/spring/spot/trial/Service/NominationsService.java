...
public class NominationsService {
    ...
    public PollProcessDTO pollProcess(UUID pollId){
        ...
        for(Nominations nomination : nominations)
        {
            ...
            nominationDTO.setEmpId(nomination.getEmployeeId());
            nominationDTO.setHeadId(nomination.getHeadId());
    ...
    //manager nominates
    public Nominations nominate(UUID pollId, String employeeId, String headId, String description, String pollName)
    {
        ...
        nominationsHistory.setHeadId(headId);
