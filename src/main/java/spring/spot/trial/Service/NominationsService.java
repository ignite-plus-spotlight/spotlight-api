...
public class NominationsService {
    ...
    //admin starts the nomination process
    ...
    //head nominates his or her immediate reportee (head = manager or director)
    ...
    //director gets the list of nominations done by him or her
                  ...
                  if(nominationsRepository.findByManagerIdAndPollId(memberId,pollingDate.getPollId()) != null)
                    if (today.compareTo(pollingDate.getPollStartDate()) >= 0 && today.compareTo(pollingDate.getPollEndDate()) <= 0) {
                      ...
                      if(nominations != null) {
                          ...
                          //check if director has either approved or rejected a nomination
    ...
    //nominations approved by director
    ...
    //nominations rejected in director' dashboard
    ...
    //nominations rejected in VP' dashboard
